...
export const russianHomeIntroduction = {
  ...
  heading: 'Независимый морской сюрвейер на Коста-Бланке, Испания',
  ...
  trustLine:
    'Услуги предоставляет морской сюрвейер яхт и малых судов с профессиональной квалификацией Yacht & Small Craft и лицензированный капитан.',
} as const;
...
export const russianHomeAbout = {
  ...
  paragraphs: [
    'All Yacht Service возглавляет Aleksandrs Tolkacovs — морской сюрвейер яхт и малых судов с профессиональной квалификацией Yacht & Small Craft и лицензированный капитан с практическим опытом управления парусными и моторными яхтами в Средиземном и Балтийском морях, Ла-Манше и Бискайском заливе.',
